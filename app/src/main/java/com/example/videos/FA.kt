...
import com.example.videos.databinding.ActivityFoldersBinding
import java.io.File

class FA : AppCompatActivity() {

    private lateinit var adapter: VAdp
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.videoRVFA.layoutManager = LinearLayoutManager(this@FA)
        adapter = VAdp(this@FA, currentFolderVideos, isFolder = true)
