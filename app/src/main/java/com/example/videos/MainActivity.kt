...
import com.example.videos.databinding.ActivityMainBinding
import com.google.android.material.color.MaterialColors
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import com.google.android.material.snackbar.Snackbar
import com.example.videos.databinding.ThemeViewBinding
...
//            Handler(Looper.getMainLooper()).postDelayed(runnable!!, 0)
        ...
        binding.bottomNav.setOnItemSelectedListener {
            when (it.itemId) {
                R.id.videoView -> setFragment(VF())
                R.id.foldersView -> setFragment(FF())
            }
        ...
        binding.navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.aboutNav -> startActivity(Intent(this, AA::class.java))
                R.id.exitNav -> exitProcess(1)
                R.id.navUrl -> startActivity(Intent(this@MainActivity, UA::class.java))
                R.id.navYoutube -> {
...
//    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        (currentFragment as VF).adapter.onResult(requestCode, resultCode)
    }
}