...
import com.example.videos.databinding.FoldersViewBinding

class FAdp(private val context: Context, private var foldersList: ArrayList<Folder>) : RecyclerView.Adapter<FAdp.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.root.setOnClickListener {
            val intent = Intent(context, FA::class.java)
